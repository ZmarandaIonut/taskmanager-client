...
import { useGetTaskHistoryQuery } from '../../../../../state/taskHistory/api';
...
const TaskHistoryPanel = () => {
  ...
  const {data, isLoading} = useGetTaskHistoryQuery({id: taskHistory.payload.taskID, page:currentPage});
  function closeTab(){
    dispatch(
      setHistoryPanel({
        isPanelActive: false,
    ...
    <div className={classes.mainContainer}>
        <div className={classes.historyPanel}>
            ...
            <div className={classes.history}>
              {isLoading ? <div className={classes.loadingContainer}><LoadingSpinner/></div> : 
              <>
              {data && data.data.task_history.map(action => {
                return <div className={classes.action} key={action.id}>
